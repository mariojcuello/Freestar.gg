    ...
    <div className="max-w-[85rem] flex px-8 mt-9 mb-2 lg:px-8 lg:mt-8 mx-auto">
      ...
      <Link
        href={{
          ...
          query: { systemID: props.systemSlug, planetID: props.planetSlug, moonID: props.moonSlug },
        }}
      >
        <h1 className="md:text-4xl text-3xl font- mb-4">{props.moon}</h1>
      </Link>
      <h1 className="md:text-4xl text-3xl  mb-4"> &nbsp;-&nbsp;</h1>
      <h1 className="md:text-4xl text-3xl font-extrabold mb-4">{props.outpost}</h1>
    </div>
  );
};

export default CrumbsOutpost;
