  ...
  return (
    <div>
      <div className="border-b border-gray-200 dark:border-gray-700 mb-5">
        <ul className=" justify-center md:justify-start flex mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
          <li className="mr-2">
            <button
      ...
      <MoonsTab system={props.system} activeTab={activeTab} />
    </div>
  );
};
