      ...
      <div className="max-w-[85rem] flex flex-nowrap justify-center gap-10 px-8 mt-9 mb-2 lg:px-8 lg:mt-8 mx-auto">
        {POPULAR_SYSTEMS.map((system) => (
          <Link
            ...
            class="flex bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-[22rem] hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
          >
            <img
              class="object-cover w-full h-full rounded-t-lg  md:h-auto md:w-48 md:rounded-none md:rounded-l-lg"
